...
const removeTask = function (index) {
  const confirmMsg = "Are you sure you want to remove this task?";
...
const sortTasks = function (column) {
...
const updateSortIcons = function () {
  ...
  if (sortColumn === 'name') {
    nameSortIcon.className = sortDirection === 'asc' ? 'fas fa-sort-up' : 'fas fa-sort-down';
  } else if (sortColumn === 'priority') {
    prioritySortIcon.className = sortDirection === 'asc' ? 'fas fa-sort-up' : 'fas fa-sort-down';
  }
};
